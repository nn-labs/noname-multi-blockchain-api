...
func GetCurrentFee(ctx context.Context, client Client, network string) (*float64, error) {
	req := BaseRequest{
		JsonRpc: "2.0",
...
func GetCurrentFeeRate(ctx context.Context, client Client, network string) (*big.Int, error) {
