...
func (m *MockHealthService) Status(network string) (*bitcoin.StatusNode, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Status", network)
...
func (mr *MockHealthServiceMockRecorder) Status(network interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Status", reflect.TypeOf((*MockHealthService)(nil).Status), network)
}
