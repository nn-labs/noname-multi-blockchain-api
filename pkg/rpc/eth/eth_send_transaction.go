...
// GetEthSendTransaction https://eth.wiki/json-rpc/API#eth_sendtransaction
func GetEthSendTransaction(client IEthClient, params map[string]string) (*BaseResponseWithStringResult, error) {
